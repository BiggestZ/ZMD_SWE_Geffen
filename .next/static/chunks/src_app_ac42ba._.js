(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_ac42ba._.js", {
...
const BookEntry = async ({ title, author, isbn, bookDesc })=>{
    let tagsList = "";
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$book_entry$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSubtopicsForBook"])(title).then(function(response) {
        tagsList = response;
    });
...
async function Home() {
    ...
    let tag = "music";
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$book_entry$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchBooksBySubtopic"])(tag).then(function(response) {
        booksList = response;
    });
...
//# sourceMappingURL=src_app_ac42ba._.js.map