...
async function searchBooksBySubtopic(subtopicName) {
    ...
    try {
        ...
        // func searchx(searchterm:  string)  : Promise<{SubtopicName : string; TopicName : string}[]}>
        // const [rows]:[any[],any]  = await connnection.exectue(query,  ['%${searchTerm}]);
        //  return rows as {SubtopicName : string; TopicName : string}[];
...
const BookEntry = ({ title, author, isbn })=>{
    let tagsList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$book_entry$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSubtopicsForBook"])(title).map();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__407c64._.js.map