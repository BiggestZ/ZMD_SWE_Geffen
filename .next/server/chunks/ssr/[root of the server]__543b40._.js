...
async function Home() {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$book_entry$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllBooks"])().then((value)=>{
        newBooksList = value;
    });
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$book_entry$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllTopics"])().then((value)=>{
        topicsList = value;
    });
    ...
    let bookArray = booksList((book)=>{});
    function matchBooks(booksList, filter) {
        let finalList = [];
        /*
        if (!filter) {
            finalList = booksList.map((book : Book) => {
                let newBook : Book = {
                    title = book.Title
                    author = book.Aitle
                    isbn = book.ISBN
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__543b40._.js.map